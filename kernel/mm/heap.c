...
INIT_TASK_DECLARE(zones_init_task, hhdm_init_task);
INIT_TASK_DEFINE(heap_init_task, INIT_TASK_SCOPE_BSP, heap_init, &zones_init_task, &hhdm_init_task);

#ifdef CONFIG_DEBUG

/* GDB can call these functions */
